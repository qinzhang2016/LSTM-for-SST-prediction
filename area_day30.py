...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 18 16:59:28 2017
...
f=open('results_30.txt','a')
f.write('120-->30 hidden=6, l_fc=1[7], l_r=1 \n')
...
for i in range(0,1):
    for j in range(1,2):
        ...
        hist=model.fit(trainX, trainY, nb_epoch=NUM_EPOCH, batch_size=batch_size, verbose=2, shuffle=False,validation_split=0.1071145)
        # make predictions0
